      ...
      <q-form ref="formEntregaMedidores">
        <div class="q-pa-md">
          <q-stepper
            ...
            >
              <div class="row q-col-gutter-sm">
                Seleccione un medidor para realizar la impresión del sertificado
  ...
  methods: {
   ...
   formatoNumero (numero, decimales) {
    ...
    consultarFiltroEntregar (consultaGeneral, isEntregado, todasFechas, fechaIni, fechaFin) {
      ...
      api.get(`/certificado/mostrarMedidoresEntregadosFechas/${consulta}/${isEntregadoCertificado}/${todasLasFechas}/${fechaIni}/${fechaFin}/${ioe}/${ipo}`)
        .then((response) => {
