        ...
        <div class="q-pa-md">
          <q-stepper
            ...
            >
                ...
                />
                <q-input class="col-xs-12 col-sm-6 col-md-3 q-pt-sm" readonly stack-label label="Registros Encontrados" v-model="LisCalibraciones.length" outlined  />
                ...
                <q-table class="col-xs-12 col-sm-12 col-md-12" title="" no-data-label="No hay registros" hide-bottom :rows-per-page-options="[0]" flat bordered
                  ...
                  <q-td key="Seleccionar_calibracion" :props="props" auto-width>
                    <q-btn :icon="props.row.Icono" :color="props.row.Color" align="center" outline @click="CargarCalibracion(props.row)"/>
                  </q-td>
                  </template>
            ...
            <q-step
                ...
                :done="step > 2"
            >                
                Seleccione cada prueba para realizar la verificación por cada repetición e ingrese observación
                <q-table class="col-xs-12 col-sm-12 col-md-12" title="" no-data-label="No hay registros" hide-bottom :rows-per-page-options="[0]" flat bordered
                ...
                <template v-slot:body="props">
                    <q-tr :props="props">
                    <q-td key="Seleccionar_calibracionprueba" :props="props" auto-width>
                      <q-btn :icon="props.row.Icono" :color="props.row.Color" align="center" outline @click="CargarCargarCalibracionPrueba(props.row)"/>
                    </q-td>
            ...
            <q-step
                ...
                :done="step > 3"
            >
              Proceda a realizar la verificación por cada repetición de la prueba <b> {{ IdCaudalMostrar }} </b>
                <q-table class="col-xs-12 col-sm-12 col-md-12" title="" no-data-label="No hay registros" hide-bottom :rows-per-page-options="[0]" flat bordered
                  ...
                  <template v-slot:body="props">
                    <q-tr :props="props">
                      <q-td key="Seleccionar_repcp" :props="props" auto-width>
                        <q-btn :icon="props.row.Icono" :color="props.row.Color" align="center" outline @click="CargarRepeticion(props.row)"/>
                      </q-td>
                      ...
                      <q-td key="Duracionh_repcp" :props="props">
                        ...
                        <q-popup-edit label-set="Modificar" label-cancel="Cancelar" v-model="props.row.Duracionh_repcp" title="Duración en horas" buttons>
                          <q-input type="number" v-model="props.row.Duracionh_repcp" autofocus>
                          <template v-slot:prepend>
                      ...
                      <q-td key="Duracionm_repcp" :props="props">
                        ...
                        <q-popup-edit label-set="Modificar" label-cancel="Cancelar" v-model="props.row.Duracionm_repcp" title="Duración en minutos" buttons>
                          <q-input type="number" v-model="props.row.Duracionm_repcp" autofocus>
                          <template v-slot:prepend>
                            <q-icon name="access_time" size="lg" />
                          </template>
                          </q-input>
                      ...
                      <q-td key="Duracions_repcp" :props="props">
                        ...
                        <q-popup-edit label-set="Modificar" label-cancel="Cancelar" v-model="props.row.Duracions_repcp" title="Duración en segundos" buttons>
                          <q-input type="number" v-model="props.row.Duracions_repcp" autofocus>
                          <template v-slot:prepend>
                            <q-icon name="access_time" size="lg" />
                          </template>
                          </q-input>
                      ...
                      <q-td key="Observacion_repcp" :props="props">
                        ...
                        <q-popup-edit label-set="Modificar" label-cancel="Cancelar" v-model="props.row.Observacion_repcp" title="Observación" buttons>
                          <q-input v-model="props.row.Observacion_repcp" autofocus>
                          <template v-slot:prepend>
            ...
            <q-step
                ...
                :done="step > 4"
            >
              Proceda a realizar la verificación de instrumentos de la prueba <b> {{ IdCaudalMostrar }} </b> de la repetición <b> {{ NRepeticion }} </b>
                <q-table class="col-xs-12 col-sm-12 col-md-12" title="" no-data-label="No hay registros" hide-bottom :rows-per-page-options="[0]" flat bordered
                  ...
                  <template v-slot:top="props">
                      ...
                      label=""
                      no-caps
                      @click="exportTable(LisRepeticionCPInstrumentos, columnsInstrumentosRepeticion)"
                      />
                      <q-space />
                      <q-btn
                      flat round dense
                  ...
                  <template v-slot:body="props">
                    <q-tr :props="props">
                      <q-td key="Seleccionar_repeticionInstrumento" :props="props" auto-width>
                        <q-btn :icon="props.row.Icono" :color="props.row.Color" align="center" outline @click="modificarLecturaInstrumento(props.row)"/>
                      </q-td>
                      ...
                      <q-td key="LecturaAnterior" :props="props">
                        {{ formatoNumeroTipo(props.row.LecturaAnterior, props.row.IdTipoInstrumento) }}
                      </q-td>
                      <q-td key="CorreccionAnterior" :props="props">
                        {{ formatoNumeroTipo(props.row.CorreccionAnterior, props.row.IdTipoInstrumento) }}
                      </q-td>
                      <q-td key="LecturaNueva" :props="props">
                        <q-badge color="green">
                          {{ formatoNumeroTipo(props.row.LecturaNueva, props.row.IdTipoInstrumento) }}
                        </q-badge>
                        <q-popup-edit label-set="Ingresar" label-cancel="Cancelar" v-model="props.row.LecturaNueva" title="Ingrese Lectura" buttons>
                          <q-input type="number" v-model="props.row.LecturaNueva" autofocus @input="val => { CalcularCorreccion(props.row) }">
                            <template v-slot:prepend>
                      ...
                      <q-td key="CorreccionNueva" :props="props">
                        {{ formatoNumeroTipo(props.row.CorreccionNueva, props.row.IdTipoInstrumento) }}
                      </q-td>
            ...
            <q-step
                ...
                :done="step > 5"
            >
              Proceda a realizar la verificación de medidores de la prueba <b> {{ IdCaudalMostrar }} </b> de la repetición <b> {{ NRepeticion }} </b>
                <q-table class="col-xs-12 col-sm-12 col-md-12" title="" no-data-label="No hay registros" hide-bottom :rows-per-page-options="[0]" flat bordered
                  ...
                  <template v-slot:top="props">
                      ...
                      label=""
                      no-caps
                      @click="exportTable(LisRepeticionCPMedidores, columnsMedidores)"
                      />
                      <q-space />
                      <q-btn
                      flat round dense
                  ...
                  <template v-slot:body="props">
                    <q-tr :props="props">
                      <q-td key="Seleccionar_repeticionMedidor" :props="props" auto-width>
                        <q-btn :icon="props.row.Icono" :color="props.row.Color" align="center" outline @click="modificarLecturaMedidor(props.row)"/>
                      </q-td>
                      ...
                      <q-td key="VolumenInicialNuevo" :props="props">
                        ...
                        <q-popup-edit label-set="Ingresar" label-cancel="Cancelar" v-model="props.row.VolumenInicialNuevo" title="Ingrese Volumen Inicial" buttons>
                          <q-input type="number" v-model="props.row.VolumenInicialNuevo" autofocus @input="val => { CalcularError(props.row) }">
                            <template v-slot:prepend>
                              <q-icon name="update" size="lg" />
                            </template>
                          </q-input>
                      ...
                      <q-td key="VolumenFinalNuevo" :props="props">
                        ...
                        <q-popup-edit label-set="Ingresar" label-cancel="Cancelar" v-model="props.row.VolumenFinalNuevo" title="Ingrese Volumen final" buttons>
                          <q-input type="number" v-model="props.row.VolumenFinalNuevo" autofocus @input="val => { CalcularError(props.row) }">
                            <template v-slot:prepend>
                              <q-icon name="update" size="lg" />
                            </template>
                          </q-input>
            ...
            <q-stepper-navigation>
                <q-btn color="primary" @click="SiguienteRepeticion()" label="Siguiente" />
            ...
            >
                ...
                <q-stepper-navigation>
                <q-btn color="primary" @click="FinalizarVerificacion()" label="Finalizar Verificación" />
...
export default {
  ...
  data () {
    return {
      ...
      VerificacionCalibracion: { Id_verifcalib: -1, Id_calibracion: -1, Fecha_verifcalib: '', Login_verifcalib: '', Observacion_verifcalib: '', Estado_verifcalib: 1, ListaVerificacionInstrumento: [], ListaVerificacionMedidor: [] },
      VerificacionCalCaudal: { Id_verifcalibcaudal: -1, Id_verifcalib: -1, Id_calprueba: -1, Tempambini_calprueba: 0, Tempambfin_calprueba: 0, Humedadrelini_calprueba: 0, Humedadrelfin_calprueba: 0, Login_verifcalibcaudal: '', Fecha_verifcalibcaudal: '', Observacion_verifcalibcaudal: '', Estado_verifcalibcaudal: 1, ListaVerificacionRepeticiones: [], Icono: 'edit', Color: 'green' },
      VerificacionCalibRepeticion: { Id_verifcalibrepeticion: -1, Id_verifcalibcaudal: -1, Id_repcp: -1, Npuestobanco_repcp: 0, Volumeninicial_repcp: 0, Volumenfinal_repcp: 0, Caudal1_repcp: 0, Caudal2_repcp: 0, Caudal3_repcp: 0, Presionent1_repcp: 0, Presionent2_repcp: 0, Presionent3_repcp: 0, Presionsal1_repcp: 0,
      Presionsal2_repcp: 0, Presionsal3_repcp: 0, Templinea1_repcp: 0, Templinea2_repcp: 0, Templinea3_repcp: 0, Temprvm_repcp: 0, Volumenrvm_repcp: 0, Duracionh_repcp: 0, Duracionm_repcp: 0, Duracions_repcp: 0, Observacion_repcp: '', Login_verifcalibrepeticion: '', Fecha_verifcalibrepeticion: '', Estado_verifcalibrepeticion: 1, Icono: 'edit', Color: 'green', colorError: 'blue' },
      ...
      RepeticioCP: { Id_repcp: -1, Id_calprueba: -1, Id_pod: 0, Nrepeticion_repcp: 0, Npuestobanco_repcp: 0, Volumeninicial_repcp: 0, Volumenfinal_repcp: 0, Caudal1_repcp: 0, Caudal2_repcp: 0, Caudal3_repcp: 0, Presionent1_repcp: 0, Presionent2_repcp: 0, Presionent3_repcp: 0, Presionsal1_repcp: 0, Presionsal2_repcp: 0, Presionsal3_repcp: 0, Templinea1_repcp: 0, Templinea2_repcp: 0, Templinea3_repcp: 0, Temprvm_repcp: 0, Volumenrvm_repcp: 0, Duracionh_repcp: 0, Duracionm_repcp: 0, Duracions_repcp: 0, Fechaini_repcp: '', Fechafin_repcp: '', Observacion_repcp: '', Estado_repcp: 1 },
      RepeticionCPInst: { IdRepeticionCPInst: 0, Id_caudal: 0, IdTipoInstrumento: 0, Id_instrumento: 0, Id_instprog: 0, Id_trazabilidadinst: 0, NombreTipoInstrumento: '', LecturaAnterior: 0, CorreccionAnterior: 0, LecturaNueva: 0, CorreccionNueva: 0, Nombre_instrumento: '', Codigo_instrumento: '', Nombre_variablemedicion: '', X_trazabilidadinst: 0, A_trazabilidadinst: 0, B_trazabilidadinst: 0, C_trazabilidadinst: 0, Factorcorreccion_trazabilidadinst: 0, Aplus_trazabilidadinst: '', Bplus_trazabilidadinst: '', Cplus_trazabilidadinst: '', FechaToma: '', Icono: 'edit', Color: 'green' },
      RepeticionCPMedidor: { IdRepeticionCPMedidor: 0, Id_repcp: 0, Id_pod: 0, NpuestoBanco: 0, VolumenInicialAnterior: 0, VolumenFinalAnterior: 0, VolumenInicialNuevo: 0, VolumenFinalNuevo: 0, Error_repcp: 0, FechaTomaIni: '', FechaTomaFin: '',  Estado: 1, Serialmedidor_ordenentradad: '', Descripcion_modelomedidor: '', Icono: 'edit', Color: 'green', colorError: 'blue' },
      VerificacionRepeticionMedidor: { IdVerificacionRepMed: 0, IdRepeticionCPMedidor: 0, Id_verifcalib: 0, VolumenInicialAnterior: 0, VolumenInicialNuevo: 0, VolumenFinalAnterior: 0, VolumenFinalNuevo: 0, Error_repcp: 0, Fecha: '', Estado: 1, Icono: 'edit', Color: 'green' },
      VerificacionRepeticionInstrumento: { IdVerificacionRepInst: 0, IdRepeticionCPInst: 0, Id_verifcalib: 0, LecturaAnterior: 0, LecturaNueva: 0, CorreccionAnterior: 0, CorreccionNueva: 0, Fecha: '', Estado: 1, Icono: 'edit', Color: 'green' },
      LisCalibraciones: [],
      ...
      vcInstrumentosRepeticion: ['Id_caudal', 'NombreTipoInstrumento', 'LecturaNueva', 'CorreccionNueva', 'Nombre_instrumento'],
      columnsInstrumentosRepeticion: [
        { name: 'Seleccionar_repeticionInstrumento', align: 'left', label: 'Modificar', field: 'Seleccionar_repeticionInstrumento', required: true, sortable: true },
        ...
        { name: 'LecturaAnterior', label: 'LecturaA', field: 'LecturaAnterior', sortable: true },
        { name: 'CorreccionAnterior', label: 'CorreccionA', field: 'CorreccionAnterior', sortable: true },
        { name: 'LecturaNueva', label: 'LecturaN', field: 'LecturaNueva', sortable: true },
        { name: 'CorreccionNueva', label: 'CorreccionN', field: 'CorreccionNueva', sortable: true },
      ...
      caudal: { Id_caudal: '', Nombre_caudal: '', Emp_caudal: 0, Factorcobertura_caudal: '', Estado_caudal: 1 },
      // time: ref('07:30'),
      listaUsuarios: [],
      ...
      ordenEntradaD: { Id_ordenentradad: -1, Id_ordenentrada: -1, Id_marcamedidor: -1, Id_modelomedidor: -1, Id_normaref: -1, Aptocalibrar_ordenentradad: '', Fabricacion_ordenentradad: '', Lectura_ordenentradad: '', Serialmedidor_ordenentradad: '', Caudalpermanente_ordenentradad: 0, Claseprecision_ordenentradad: 0, Presionmax_ordenentradad: 0, Perdidapresion_ordenentradad: '',
        Rangomedicion1_ordenentradad: 0, Rangomedicion2_ordenentradad: 0, Clasetemperatura_ordenentradad: '', Sensibilidadaar_ordenentradad: '', Sebsibilidadaab_ordenentradad: '', Identificador_ordenentradad: 0, Clasemetrologica_ordenentradad: '', Precisionnominal_ordenentradad: 0, Observacion_ordenentradad: '', Estado_ordenentradad: 0, Nombre_marcamedidor: '', Descripcion_modelomedidor: '', Nombre_normaref: '', Marcamedidor: { Id_marcamedidor: null, Nombre_marcamedidor: '' }, Modelomedidor: { Id_modelomedidor: null, Descripcion_modelomedidor: '', Diametronominal_modelomedidor: '' }, Icono: 'edit', Color: 'green', Incidencias: 0, ListaIncidencias: [], Programado_ordenentradad: 0, Calibrado_ordenentradad: 0, Certificado_ordenentradad: 0 },
      columnsMedidores: [
        { name: 'Seleccionar_repeticionMedidor', align: 'left', label: 'Modificar', field: 'Seleccionar_repeticionMedidor', required: true },
        { name: 'IdRepeticionCPMedidor', align: 'left', label: 'IdRCPM', field: 'IdRepeticionCPMedidor' },
        { name: 'NpuestoBanco', align: 'left', label: 'Puesto', field: 'NpuestoBanco', required: true },
        ...
        { name: 'VolumenInicialAnterior', label: 'VolumenIniA', field: 'VolumenInicialAnterior' },
        { name: 'VolumenFinalAnterior', label: 'VolumenFinA', field: 'VolumenFinalAnterior' },
        { name: 'VolumenInicialNuevo', label: 'VolumenIniN', field: 'VolumenInicialNuevo' },
        { name: 'VolumenFinalNuevo', label: 'VolumenFinN', field: 'VolumenFinalNuevo' },
        { name: 'Error_repcp', label: 'Error', field: 'Error_repcp', sortable: true },
      ...
      vcMedidores: ['NpuestoBanco', 'Serialmedidor_ordenentradad', 'VolumenInicialNuevo', 'VolumenFinalNuevo', 'Error_repcp', 'Descripcion_modelomedidor'],
      columnsPruebas: [
        ...
        { name: 'Caudal_caudal', label: 'Caudal', field: 'Caudal_caudal', sortable: true },
      ...
      vcRepeticionesCP: ['Id_calprueba', 'Nrepeticion_repcp', 'Fechaini_repcp', 'Fechafin_repcp'],
      columnsRepeticionesCP: [
        { name: 'Seleccionar_repcp', align: 'left', label: 'OK', field: 'Seleccionar_repcp', required: true, sortable: true },
  ...
  created () {
    const instrumento = { Id_instrumento: -1, IdTipoInstrumento: 0, Id_variablemedicion: '', Nombre_variablemedicion: '', Nombre_instrumento: '', Serial_instrumento: '', Codigo_instrumento: '', Descripcion_instrumento: '', Activo_instrumento: 1, Login_instrumento: '', LisTrazabilidadInstrumentos: [] }
  ...
  methods: {
    ...
    CalcularError (fila) {
      const self = this
      fila.Error_repcp = ((((fila.VolumenFinalNuevo - fila.VolumenInicialNuevo) * 1000) - (this.VolumenRecipiente * 1000)) / (this.VolumenRecipiente * 1000)) * 100
    ...
    modificarLecturaInstrumento (RepInst) {
      if (RepInst.LecturaAnterior === RepInst.LecturaNueva) {
        utils.mensaje('No hay variación de lecturas, no es necesario modificar')
        return
      }
      this.$q.dialog({
        title: 'SILAMED',
        dark: true,
        message: 'Está seguro de modificar las lecturas del intrumento <br>Instrumento: ' + RepInst.NombreTipoInstrumento + '<br>Lectura Actual: ' + RepInst.LecturaAnterior + '<br>Lectura Nueva: ' + RepInst.LecturaNueva,
        cancel: true,
        persistent: true,
        html: true
      }).onOk(() => {
    ...
    modificarLecturaMedidor (RepMed) {
      if (RepMed.VolumenInicialNuevo === RepMed.VolumenInicialAnterior && RepMed.VolumenFinalNuevo === RepMed.VolumenFinalAnterior) {
        utils.mensaje('No hay variación de lecturas, no es necesario modificar')
        return
      }
      this.$q.dialog({
        title: 'SILAMED',
        dark: true,
        message: 'Está seguro de modificar las lecturas del medidor <br>Serial: ' + RepMed.Serialmedidor_ordenentradad + 
        '<br>Volumen Inicial: ' + RepMed.VolumenInicialAnterior + ' Cambia a ' + RepMed.VolumenInicialNuevo + 
        '<br>Volumen Final: ' + RepMed.VolumenFinalAnterior + ' Cambia a ' + RepMed.VolumenFinalNuevo,
        cancel: true,
        persistent: true,
        html: true
      }).onOk(() => {
    ...
    VerificarRepeticion () {
      ...
      if (this.LisCalibracionPrueba.length > 0) {
        this.VerificacionCalibracion.ListaVerificacionCaudal.push(this.VerificacionCalCaudal)
        this.step = 2  
      } else {
        this.VerificacionCalibracion.ListaVerificacionCaudal.push(this.VerificacionCalCaudal)
        this.step = 4
    ...
    CargarRepeticion (Rep) {
      ...
      for (const Iti of Rep.LisRepeticionCPInstrumento) {
        ...
        repeticionInstrumento.IdTipoInstrumento = Iti.InstrumentoProgramacion.IdTipoInstrumento
        repeticionInstrumento.Id_instrumento = Iti.InstrumentoProgramacion.Id_instrumento
        repeticionInstrumento.Id_instprog = Iti.Id_instprog
        repeticionInstrumento.Id_trazabilidadinst = Iti.InstrumentoProgramacion.Id_trazabilidadinst
        repeticionInstrumento.NombreTipoInstrumento = Iti.InstrumentoProgramacion.Instrumento.NombreTipoInstrumento
        ...
        repeticionInstrumento.Nombre_instrumento = Iti.InstrumentoProgramacion.Instrumento.Nombre_instrumento
        repeticionInstrumento.Codigo_instrumento = Iti.InstrumentoProgramacion.Instrumento.Codigo_instrumento
        repeticionInstrumento.Nombre_variablemedicion = Iti.InstrumentoProgramacion.Instrumento.Nombre_variablemedicion
        repeticionInstrumento.X_trazabilidadinst = Iti.InstrumentoProgramacion.TrazabilidadInstrumento.X_trazabilidadinst
        repeticionInstrumento.A_trazabilidadinst = Iti.InstrumentoProgramacion.TrazabilidadInstrumento.A_trazabilidadinst
        repeticionInstrumento.B_trazabilidadinst = Iti.InstrumentoProgramacion.TrazabilidadInstrumento.B_trazabilidadinst
        repeticionInstrumento.C_trazabilidadinst = Iti.InstrumentoProgramacion.TrazabilidadInstrumento.C_trazabilidadinst
        repeticionInstrumento.Factorcorreccion_trazabilidadinst = Iti.InstrumentoProgramacion.TrazabilidadInstrumento.Factorcorreccion_trazabilidadinst
        repeticionInstrumento.Aplus_trazabilidadinst = Iti.InstrumentoProgramacion.TrazabilidadInstrumento.Aplus_trazabilidadinst
        repeticionInstrumento.Bplus_trazabilidadinst = Iti.InstrumentoProgramacion.TrazabilidadInstrumento.Bplus_trazabilidadinst
        repeticionInstrumento.Cplus_trazabilidadinst = Iti.InstrumentoProgramacion.TrazabilidadInstrumento.Cplus_trazabilidadinst
      ...
      for (const Rm of Rep.LisRepeticionCPMedidor) {
        ...
        repeticionMedidor.Descripcion_modelomedidor = Rm.Descripcion_modelomedidor
        ...
        repeticionMedidor.Error_repcp = ((((Rm.VolumenFinal - Rm.VolumenInicial) * 1000) - (this.VolumenRecipiente * 1000)) / (this.VolumenRecipiente * 1000)) * 100
        if (repeticionMedidor.Error_repcp > self.caudal.Emp_caudal || repeticionMedidor.Error_repcp < (self.caudal.Emp_caudal * -1)) {
        ...
        repeticionMedidor.Serialmedidor_ordenentradad = Rm.Serialmedidor_ordenentradad
    ...
    CargarCargarCalibracionPrueba (CP) {
      ...
      self.VerificacionCalCaudal.Humedadrelini_calprueba = CP.Humedadrelini_calprueba
      self.VerificacionCalCaudal.Humedadrelfin_calprueba = CP.Humedadrelfin_calprueba
      self.VerificacionCalCaudal.Login_verifcalibcaudal = self.usuario.LoginUsuario
    ...
    AceptarVerificacionRepeticion(Repeticion) {
      ...
      self.VerificacionCalCaudal.ListaVerificacionRepeticiones.push(verifRepeticion)
    ...
    guardarVerificacionCalibracion () {
      const self = this
      self.VerificacionCalibracion.ListaVerificacionInstrumento = self.LisRepeticionInsMOD
      self.VerificacionCalibracion.ListaVerificacionMedidor = self.LisRepeticionMedMOD
      this.$q.dialog({
        title: 'SILAMED',
        dark: true,
        ...
        api.post('/calibracionmedidores/insertarVerificacionCalibracion/', this.VerificacionCalibracion)
        .then((response) => {
