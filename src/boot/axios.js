...
//const api = axios.create({ baseURL: 'http://170.0.1.62/WebApiSILAMED/api/' })
const api = axios.create({ baseURL: 'http://170.0.0.19/WebApiSILAMED/api/' })
//const api = axios.create({ baseURL: 'http://170.0.0.21/WebApiSILAMED/api/' })
...
//const api = axios.create({ baseURL: 'http://192.168.224.2/WebApiSILAMED/api/' })
