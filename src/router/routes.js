...
const routes = [
  {
    ...
    children: [
      ...
      { path: '/Procesos/AccionesCorrectivas', component: () => import('pages/Procesos/AccionesCorrectivas.vue') },
      { path: '/Procesos/AccionesCorrectivasAcTomar', component: () => import('pages/Procesos/AccionesCorrectivasAcTomar.vue') },
      { path: '/Procesos/AccionesCorrectivasResultVerif', component: () => import('pages/Procesos/AccionesCorrectivasResultVerif.vue') },
